...
//        *** Terminating app due to uncaught exception 'CALayerInvalid', reason: 'layer <CAGradientLayer: 0x600000560d60> is a part of cycle in its layer tree'
//        Adding a layer to itself 🤦‍♂️ . After this mistake I am planning to kill myself :(.
//        layer.addSublayer(layer)
        
//        gradientLayer.mask = self.label.layer
//        self.label.layer.insertSublayer(gradientLayer, at: 0)
